...
class CommentAPIViewTestCase(TestCase):
    def setUp(self):
        ...
        self.story = Story.objects.create(body='Test body', user=User.objects.create(username='testuser', password='testpassword',alias='testalias'))
        self.story.categories.add(self.categories)
        self.comment_data = {'body': 'Test comment body', 'story': self.story.pk}
        self.user = User.objects.create(email='comment_user@gmail.ir',username='comment_user', password='password123',alias = 'comment_user')
    ...
    def test_retrieve_comment(self):
        comment = Comment.objects.create(body='Test comment body', user=self.user, story=self.story)
    ...
    def test_list_admin_comments(self):
        ...
        admin_user = User.objects.create_user(username='admin', password='password123',email='admin@gmail.com', type='Administrator')
